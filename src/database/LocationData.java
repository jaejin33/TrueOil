...
public enum LocationData {
	DONG_EUI("동의대역", 496541, 283842, 35.154031, 129.032212), SEOMYEON("서면역", 496850, 284520, 35.15771, 129.05917),
	BUSAN_STN("부산역", 495500, 280100, 35.11522, 129.04224), HAEUNDAE("해운대역", 508200, 285400, 35.16311, 129.15890),
	SASANG("사상역", 492212, 284770, 35.162361, 128.984621), HADAN("하단역", 488200, 279500, 35.10618, 128.96680);
