...
public class MainPage extends JFrame {
    ...
    public MainPage() {
        ...
        gbc.gridx = 0; btnGroupPanel.add(profilePhoto, gbc);
        gbc.gridx = 1; btnGroupPanel.add(userLabel, gbc);
        gbc.gridx = 2; btnGroupPanel.add(logoutBtn, gbc);
        gbc.gridx = 3; gbc.insets = new Insets(0, 5, 0, 20); btnGroupPanel.add(exitBtn, gbc);
